public class SimpleQueue {
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Add the value to the end of the list
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Get the first value in the queue
        _queue.RemoveAt(0); // Remove the first value from the queue
        return value;
    }
}